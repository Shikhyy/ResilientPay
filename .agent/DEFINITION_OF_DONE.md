...
Source document retained and reorganized from: .agent/DEFINITION_OF_DONE.md
...
- [ ] Relevant protocol/architecture specification remains correct.
- [ ] Unit tests added/updated.
- [ ] Integration tests added/updated when a boundary changed.
- [ ] Security tests added/updated when a security boundary changed.
- [ ] Error handling is explicit.
- [ ] State transitions remain valid.
- [ ] No policy/security constants were silently changed.
- [ ] Lint/static analysis passes.
- [ ] Relevant tests pass.
- [ ] No secrets or unsafe debug logging introduced.
- [ ] Traceability updated.
- [ ] Documentation updated.
- [ ] Diff reviewed for unintended changes.
- [ ] Agent report includes commands, evidence, and unresolved risks.
