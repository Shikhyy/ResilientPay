...
Source document retained and reorganized from: .agent/task-format.md
...
## Context
Relevant specification and ADR links.

## Inputs
Exact types/files/APIs.
...
## Tests
Exact unit/integration/security tests.
...
A task is ready for an agent only when the objective and acceptance criteria are testable.
